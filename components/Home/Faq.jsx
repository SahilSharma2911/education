      ...
      <div className="w-9/12 lg:item-center lg:flex lg:flex-row lg:justify-between mx-auto">
        ...
        <div className=" space-y-8  w-full">
          ...
          <div className=" w-full flex justify-between">
            ...
            <div>
              <h1 className=" font-heading font-semibold">
                What are the top attractions included in your tours?
              </h1>
              {faq1 && (
                <p className=" font-text mt-3 w-10/12">
                  Providing a detailed list of popular attractions covered in
                  your tours can attract search queries related to those
                  destinations, Explain the booking process clearly, including
                  steps and any necessary information, to capture search queries
                  about booking procedures
                </p>
              )}
            </div>
          ...
          <div className=" flex justify-between">
            ...
            <div>
              <h1 className=" font-heading font-semibold">
                What safety measures are in place for tours?
              </h1>
              {faq4 && (
                <p className=" font-text mt-3">
                  Providing a detailed list of popular attractions covered in
          ...
          <div className=" flex justify-between">
            ...
            <div>
              <h1 className=" font-heading font-semibold">
                Do you offer customized or private tours?
              </h1>
              {faq7 && (
                <p className=" font-text mt-3">
                  Providing a detailed list of popular attractions covered in
