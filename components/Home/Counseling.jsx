      ...
      <div className="w-10/12 mx-auto py-[3rem]">
        ...
        <div className=" flex gap-5 md:flex-wrap md:flex-row flex-col items-center justify-between mt-[3rem] flex-wrap">
          ...
          <div className="w-8/12 md:w-5/12 lg:w-2/12  flex flex-col items-center gap-3 text-center">
            <div className="bg-[#1F94F3] w-[3.5rem] font-bold text-white text-[2rem] rounded-full flex justify-center items-center h-[3.5rem]">
              1
            </div>
            <div>
            ...
            <p className=" font-jost">Free Expert Counseling Service</p>
          </div>
          ...
          <div className="w-8/12  md:w-5/12 lg:w-2/12 flex flex-col items-center gap-3 text-center">
            ...
            <p className=" font-jost">Identify Course, Country & University</p>
          </div>
          ...
          <div className="w-8/12 md:w-5/12 lg:w-2/12 flex flex-col items-center gap-3 text-center">
            ...
            <p className=" font-jost">International Test Preparation</p>
          </div>
          ...
          <div className="w-8/12 md:w-5/12 lg:w-2/12 flex flex-col items-center gap-3 text-center">
            ...
            <p className=" font-jost">FApplication Editing & Processing</p>
          </div>
          ...
          <div className="w-8/12 md:w-5/12 lg:w-2/12 flex flex-col items-center gap-3 text-center">
            ...
            <p className=" font-jost">Funding, Visa & Pre- Departure Prep.</p>
          </div>
        </div>
      </div>
    </div>
