    ...
    <div className="w-[100vw] h-auto ">
      <div className="w-10/12 flex flex-col mx-auto pb-[1.2rem] md:pb-[2rem] pt-[3rem]">
        ...
        <div className="space-y-1">
          ...
          <p className=" font-jost text-center text-[#5C6066] text-[14px] md:text-[16px]">Road Map to Study Abroad</p>
        </div>
            ...
            <div className="flex flex-col-reverse lg:flex-col gap-[1.5rem] lg:gap-[6rem] items-center">
              ...
              <div className="text-center lg:text-end lg:pr-10">
                <span className="hidden lg:flex flex-col">
                  <h1 className=" font-poppins font-bold md:text-[25px] text-[#666666] leading-[16px] md:leading-[36px]">
