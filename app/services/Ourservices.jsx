      ...
      <div className="w-10/12 flex flex-col mx-auto py-[3rem]">
        ...
        <div className=" flex flex-col lg:flex-row mx-auto justify-evenly gap-4 w-full h-auto my-[3rem] ">
          ...
          <div className=" w-full flex  flex-col gap-[6rem] text-center items-center ">
            ...
            {/* text section  */}
            <div>
              <h1 className=" font-poppins font-bold text-[1.3rem]">
                Short Listing & Application
              </h1>
              <p className=" font-jost">
                We Thoroughly Assess Your Profile And Help You Select The Best
                Countries, Universities & Courses Meeting Your Goals.
              </p>
            </div>
            ...
            <div>
              ...
              <p className=" font-jost">
                We Help You Get Scholarship And Education Loan. We Also Offer
                Guaranteed SIO Scholarship Of Up To Rs. 20,000.
              </p>
            </div>
          ...
          <div className=" text-center items-center w-full flex  flex-col gap-[6rem] mt-[4rem] ">
            ...
            <div>
              ...
              <p className=" font-jost">
                We Provide Excellent Offline & Online Coaching For IELTS/ TOEFL/
                PTE/ GRE/ GMAT/ SAT at the most affordable fee.
              </p>
            </div>
            ...
            <div>
              ...
              <p className=" font-jost">
                We Apply For Your Visa At Your Convenient Time, In Your Presence
                Or By Screen-Sharing To Ensure 100% Transparency.
              </p>
            </div>
